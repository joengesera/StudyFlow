...
export const columns: TaskColumnDef[] = [
    { key: 'PENDING', label: 'A faire', dot: '#737373', border: 'border-[#E5E5E5]', bg: 'bg-[#FAF9F6]' },
    { key: 'IN_PROGRESS', label: 'En cours', dot: '#F59E0B', border: 'border-[#F59E0B]', bg: 'bg-[#FAF9F6]' },
    { key: 'COMPLETED', label: 'Terminees', dot: '#10B981', border: 'border-[#E5E5E5]', bg: 'bg-[#FAF9F6]' },
    { key: 'CANCELED', label: 'Annulees', dot: '#A3A3A3', border: 'border-[#E5E5E5]', bg: 'bg-[#FAF9F6]' },
];
